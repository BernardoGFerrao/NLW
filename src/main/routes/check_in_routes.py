...
from RocketSeat.NLW.src.data.check_in_handler import CheckInHandler
from RocketSeat.NLW.src.http_types.http_request import HttpRequest
from RocketSeat.NLW.src.errors.error_handler import handle_error
...
def create_check_in_route(attendee_id):
    try:
